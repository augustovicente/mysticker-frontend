...
const SideBar = () => {
    return (
        <div className="sidebar">
            <div className="sidebar-logo mb-50">
                <a href="/"><img src="assets/img/logo/logo.png" alt="Logo MySticker" /></a>
            </div>
            <div className="sidebar-icon">
                <ul>
                    <li className="active"><a href="/"><i className="fi-sr-home" /></a></li>
                    <li className='d-none'><a href="/nft-live-bidding"><i className="fi-sr-book-alt" /></a></li>
