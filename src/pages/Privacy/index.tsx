    ...
    return (
        <Container>
            <article>
                ...
                <p>
                    Seja bem-vindo ao MySticker! <br />
                    Estes termos e condições descrevem as regras de uso do site da empresa MySticker, localizado no endereço https://mysticker.io.
                </p>

                <p>
                    Ao acessar este site, consideramos que você está de acordo com os termos e condições abaixo. Não continue a usar o MySticker caso você discorde dos termos e condições descritos neste contrato.
                </p>
            </article>
            ...
            <article>
                ...
                <p>
                    O site usa cookies para ajudar na personalização da sua experiência na internet. Ao acessar o site MySticker, você concorda com o uso dos cookies requeridos.
                </p>
            ...
            <article>
                ...
                <p>
                    Exceto em casos em que for indicado o contrário, MySticker e seus licenciados têm direito à propriedade intelectual de todo o material postado no MySticker. Todos os direitos à propriedade intelectual são reservados.
                </p>
                ...
                <ul>
                    <li>Copiar ou republicar materiais do MySticker</li>
                    <li>Vender, alugar ou sublocar materiais do MySticker</li>
                    <li>Reproduzir, duplicar ou copiar materiais do MySticker</li>
                    <li>Redistribuir conteúdos do MySticker</li>
                </ul>
                ...
                <p>
                    Partes deste site oferecem ao usuário a oportunidade de postar e discutir opiniões e informações em determinadas áreas. MySticker não filtra, edita, publica ou revisa Comentários antes que eles sejam apresentados no site. Comentários refletem as opiniões da pessoa que os posta. Na extensão em que as leis aplicáveis permitem, MySticker não se responsabiliza legalmente pelos Comentários ou quaisquer danos, riscos ou despesas causadas ou sofridas como resultado do uso, e/ou postagem e/ou aparência dos Comentários deste site.
                </p>

                <p>
                    MySticker reserva para si o direito de remover quaisquer Comentários que possam ser considerados inapropriados, ofensivos ou quebrem os Termos e Condições deste contrato.
                </p>
                ...
                <p>
                    Você por meio deste concede a MySticker a licença não-exclusiva de usar, reproduzir, editar e autorizar outros a usar, reproduzir ou editar qualquer um de seus Comentários em qualquer e todas as formas, formatos e mídias.
                </p>
            </article>

            <article>
                <strong>Criação de links para nosso conteúdo</strong>
                ...
                <p>
                    Se você representa uma das organizações listadas no parágrafo 2 acima e está interessado em postar um link para nosso site, você deve nos informar de seu interesse enviando um e-mail para MySticker. Por favor, inclua seu some, o nome da sua organização e suas informações de contato, assim como a URL do seu site, uma lista das URLs do nosso site que você pretende usar como links, e uma lista dos sites nos quais você pretende publicar nossas URLs. Aguarde entre 2 e 3 semanas para receber uma resposta.
                </p>
                ...
                <p>
                    Não será permitido o uso ou a publicação de links para o logo e/ou outros elementos visuais da MySticker sem um acordo de licença para o uso da marca registrada.
                </p>
            </article>

            <article>
                <strong>Responsabilização pelo Conteúdo:</strong>
            ...
            <article>
                <strong>Reserva de Direitos:</strong>
            ...
            <article>
                <strong>Remoção de links postados em nosso site:</strong>
            ...
            <article>
                <strong>Declaração de Isenção de Responsabilidade:</strong>
            ...
            <article>
                ...
                <p>
                    Diante de uma adversidade no processo da compra, por se tratar de uma transação de criptomoedas e não haver notas fiscais, não é possível realizar nenhum tipo de reembolso.
                </p>
            </article>
        </Container>
    )
